        ...
        <div className="h-screen bg-gray-300 flex">
            <div className="rounded-sm w-1/3 px-10 pt-10 pb-2 bg-white mx-auto mt-36 h-1/2">
                <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="btn no-animation text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium block w-full text-center">Submit</button>
                </form>
            ...
            {isError && <div className="alert alert-error shadow-lg flex absolute bottom-4 right-4 w-1/3">
                            <div className="flex">
