...
import { updateInsurance, deleteInsurance } from "../features/insurance/insuranceSlice"
    ...
    return(
        ...
        <div className="flex flex-row justify-between">
            <div className="flex flex-col">
                <h1 className="text-sm font-thin">Provider:</h1>
                <h1>{props.insurance.provider}</h1>
            </div>
                        ...
                        <div className="relative w-2/5 my-6 mx-auto">               
                            <div className='border relative bg-white rounded-lg'>
                                <div className="border-b-2 flex flex-row justify-between p-5">
                                    <h1 className="text-xl font-bold">Edit Insurance</h1>
        ...
        <div className="flex flex-col">
            <h1 className="text-sm font-thin">Policy;</h1>
            <h1>{props.insurance.policy}</h1>
        </div>
        <div className="flex flex-col">
            <h1 className="text-sm font-thin">Vin:</h1>
            <h1>{props.insurance.vin}</h1>
        </div>
        <div className="flex flex-row justify-between">
            <div className="flex flex-col">
                <h1 className="text-sm font-thin">Created:</h1>
                <h1>{props.insurance.createdAt.substring(0,10)}</h1>
            </div>
            <div className="flex flex-col">
                <h1 className="text-sm font-thin">Updated:</h1>
                <h1>{props.insurance.updatedAt.substring(0,10)}</h1>
            </div>
        </div>
        </div>
    )
