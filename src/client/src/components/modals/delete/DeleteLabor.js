...
import { deleteLabor } from "../../../features/labor/laborSlice"


export default function DeleteLabor(props){
    ...
    return(
        ...
        <div className="modal-box relative bg-gray-800 flex">
            ...
            <h3 className="text-center text-lg font-bold text-white">Are You Sure You Want To Delete Labor?</h3>
