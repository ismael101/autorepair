...
import { deleteInsurance } from "../../../features/insurance/insuranceSlice"

export default function DeleteInsurance(props){
    ...
    return(
        ...
        <div className="modal-box relative bg-gray-800 flex">
            ...
            <h3 className="text-center text-lg font-bold text-white">Are You Sure You Want To Delete Insurance?</h3>
