...
export default function AddWork(){
    ...
    return(
        <div>
            <label htmlFor="add_work" className="btn no-animation normal-case text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium">Add Work</label>
            <input type="checkbox" id="add_work" className="modal-toggle" />
            <div className="modal">
            <div className="modal-box relative bg-white">
                <label htmlFor="add_work" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
                ...
                <form className='m-5 space-y-5' onSubmit={handleSubmit}>
                    ...
                    <button htmlFor="add_work" type='submit' className='btn no-animation normal-case text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium'>Submit</button>
                </form>
            </div>
            </div> 
        </div>
