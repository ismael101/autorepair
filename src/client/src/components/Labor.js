import { updateLabor, deleteLabor } from "../features/labor/laborSlice"
...
export default function Labor(props){
    ...
    const [location, setLocation] = useState(props.labor.location)
    ...
    return(
        <div className={`border-l-4 flex flex-row h-20 w-full p-4 bg-white place-items-center ${props.labor.complete ? "border-green-600" : "border-red-600"}`}>
            <div className="flex flex-col place-items-start w-3/12">
                <h1 className="font-thin text-md">Title:</h1>
                <h1>{props.labor.task}</h1>
            </div>
            <div className="flex flex-col place-items-start w-2/12">
                <h1 className="font-thin text-md">Location:</h1>
                <h1 className="" >{props.labor.location}</h1>
            </div>
            <div className="flex flex-col place-items-start w-2/12">  
                <h1 className="font-thin text-sm">Cost:</h1>
                <h1 className="text-green-600">${props.labor.cost.toFixed(2)}</h1>
            </div>
            <div className="flex flex-col place-items-start w-2/12">
                <h1 className="font-thin text-sm">Created:</h1>
                <h1 className="font-thin">{props.labor.createdAt.substring(0,10)}</h1>
            </div>
            <div className="flex flex-col place-items-start w-2/12">
                <h1 className="font-thin text-sm">Updated:</h1>
                <h1 className="font-thin">{props.labor.updatedAt.substring(0,10)}</h1>
            </div>
                        ...
                        <div className="relative w-2/5 my-6 mx-auto">               
                            <div className='border relative bg-white rounded-lg'>
                                <div className="border-b-2 flex flex-row justify-between p-5">
                                    <h1 className="text-xl font-bold">Edit Labor</h1>
                        ...
                        <div className="relative w-2/5 my-6 mx-auto">               
                            <div className='border relative bg-white rounded-lg'>
                                ...
                                <div className="flex flex-col space-y-5 p-5">
                                    ...
                                    <h1 className="text-center text-2xl">Are You Sure You Want To Delete Labor?</h1>
