...
export default function Work(props){
    ...
    const handleUpdate = () => {
        dispatch(updateWork(props.work.id, {title:props.work.title, description:props.work.description, complete:props.work.complete}))
    }
    ...
    return(
            <div className={`bg-white flex flex-col space-y-2 rounded-lg p-4 w-1/3 shadow-md hover:shadow-lg border-2 cursor-pointer ${props.work.complete ? "border-green-600" : "border-red-600"}`}>
                                        ...
                                        <div>
                                            <form onSubmit={(e) => {handleDelete(e)}}>
                                                ...
                                                <div className="mx-4 my-1">
                                                    ...
                                                    <textarea value={description} onChange={(e) => {setDescription(e.target.value)}} rows="4"  type='text' id="description" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Camry" required/>
                                                </div>
                                                <div className="mx-4 my-1">
                ...
                <div className="flex flex-row justify-between">
                    <div className="flex flex-col">
                        ...
                        <h1>{props.work.customer.first} {props.work.customer.last}</h1>
                    </div>
                    <div className="flex flex-col">
                        <h1 className="font-thin text-sm">Vehicle</h1>
                        <h1>{props.work.vehicle.make} {props.work.vehicle.model}</h1>
                    </div>
                    <div className="flex flex-col">
                        <h1 className="font-thin text-sm">Insurance</h1>
                        <h1>{props.work.insurance.provider}</h1>
                    </div>
                </div>
                <div className="flex flex-row justify-between">
                    <div className="flex flex-col">
